...
#' @format A data frame with 2219 rows and 34 variables:
#' \describe{
#'   \item{\code{CVE_MUN}}{character COLUMN_DESCRIPTION}
#'   \item{\code{CVE_LOC}}{character COLUMN_DESCRIPTION}
#'   \item{\code{Average_Chlorophyll}}{double COLUMN_DESCRIPTION}
...
#'   \item{\code{Average_Phytoplankton}}{double COLUMN_DESCRIPTION}
...
#'   \item{\code{Minimum_Phytoplankton}}{double COLUMN_DESCRIPTION}
