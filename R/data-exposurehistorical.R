...
#' @format A data frame with 2219 rows and 42 variables:
#' \describe{
#'   \item{\code{CVE_MUN}}{character COLUMN_DESCRIPTION}
#'   \item{\code{CVE_LOC}}{character COLUMN_DESCRIPTION}
#'   \item{\code{anthropogenic_index}}{double COLUMN_DESCRIPTION}
...
#'   \item{\code{biodiversity_impact}}{double COLUMN_DESCRIPTION}
#'   \item{\code{elevation}}{double COLUMN_DESCRIPTION}
#'   \item{\code{long_term_precipitation}}{double COLUMN_DESCRIPTION}
#'   \item{\code{long_term_temperature}}{double COLUMN_DESCRIPTION}
#'   \item{\code{mangrove_change}}{double COLUMN_DESCRIPTION}
...
#'   \item{\code{red_tides}}{double COLUMN_DESCRIPTION} 
#'}
#' @details DETAILS
"exposurehistorical"